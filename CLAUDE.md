...
├── auth/                  # 소셜 로그인/가입(register/complete에 phoneNumber 필수 — PII, 응답 비노출), JWT 발급·refresh rotation, registerToken
├── user/                  # 사용자 / 내 정보(/me) · 프로필 수정 · 탈퇴 · 인앱 투어 완료(POST /me/tour/complete)
