...
import com.hazel.settings.dto.LabelSettingCreateRequest
import com.hazel.settings.dto.LabelSettingResponse
import com.hazel.settings.dto.LabelSettingUpdateRequest
import com.hazel.settings.service.SaleCategorySettingService
import com.hazel.settings.service.SalePaymentMethodSettingService
...
@Tag(name = "SaleSettings", description = "매출 설정(카테고리/결제방식)")
@RestController
